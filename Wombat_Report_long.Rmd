...
Create_DT(x = BeforeQC, caption = 'Table 1: Before QC')
```
...
ggplot(data = BeforeQC, aes(x = Sample, y = R1Reads)) +
  ...
  labs(x = "Samples", y = "Number of Reads", title = "Before CQ - R1") +
...
ggplot(data = BeforeQC, aes(x = Sample, y = R1LenMean)) +
  ...
  theme(panel.border = element_blank(),
        ...
        axis.text = element_text(size = 10),
        axis.title = element_text(size = 12, face = "bold")) +
  labs(x = "Samples", y = "Average read length", title = "Before CQ - R1") + 
...
ggplot(data = BeforeQC, aes(x = Sample, y = R2Reads)) +
  ...
  theme(panel.border = element_blank(),
        ...
        axis.text = element_text(size = 10),
        axis.title = element_text(size = 12, face = "bold")) +
  labs(x = "Samples", y = "Number of Reads", title = "Before CQ - R2") +
...
ggplot(data = BeforeQC, aes(x = Sample, y = R2LenMean)) +
  ...
  theme(panel.border = element_blank(),
        ...
        axis.text = element_text(size = 10),
        axis.title = element_text(size = 12, face = "bold")) +
  labs(x = "Samples", y = "Average read length", title = "Before CQ - R2") + 
...
Create_DT(x = AfterQC, caption = 'Table 2: After QC')
```
...
Create_DT(x = FLASH_Reads, caption = 'Table 3: FLASH summary')
```
...
Create_DT(x = Assembly_full, caption = 'Table 4: Assembly analysis summary')
```
...
ggplot(data = Assembly_full, aes(x = Sample, y = Contigs)) +
  ...
  facet_grid(rows = vars(ST), cols = vars(`Clonal complex`), margins = FALSE)
)
```
...
Number_of_contigs <-
  ggplotly(
ggplot(data = Assembly_full, aes(x = Sample, y = Contigs, fill = factor(ST))) +
  geom_bar(stat = "identity") +
  theme(panel.border = element_blank(),
        panel.background = element_blank(),
        panel.grid.minor = element_line(colour = "grey90"),
...
```{r, echo=FALSE}
options("scipen" = 100, "digits" = 0)
Draft_genome_lengh <- ggplotly(
ggplot(data = Assembly_full, aes(x = Sample, y = GenomeLen, fill = factor(ST))) +
  geom_bar(stat = "identity") +
  theme(panel.border = element_blank(),
        panel.background = element_blank(),
        panel.grid.minor = element_line(colour = "grey90"),
...
# Move the label further to the left
Draft_genome_lengh[['x']][['layout']][['annotations']][[2]][['x']] <- -0.11
