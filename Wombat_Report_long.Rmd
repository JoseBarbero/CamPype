...
ggplot(data = Assembly_full, aes(x = factor(ST), y = GenomeLen, fill = Sample)) +
  geom_bar(stat = "identity") +
  theme(panel.border = element_blank(),
        panel.background = element_blank(),
        panel.grid.minor = element_line(colour = "grey90"),
        ...
        axis.text = element_text(size = 10),
        axis.title = element_text(size = 12, face = "bold")) +
  labs(x = "Clonal complex", y = "Genome lengh (bp)", title = "", fill = "Sample") +
...
Contig_length <- 
ggplotly(
ggplot(data = Assembly_full, aes(x = factor(ST), y = ContigLen, fill = Sample)) +
  geom_bar(stat = "identity") +
  theme(panel.border = element_blank(),
        panel.background = element_blank(),
        panel.grid.minor = element_line(colour = "grey90"),
        ...
        axis.text = element_text(size = 10),
        axis.title = element_text(size = 12, face = "bold")) +
  labs(x = "Samples", y = "Average contig length (bp)", title = "", fill = "Sample") +
  facet_grid(cols = vars(`Clonal complex`), margins = FALSE) +
