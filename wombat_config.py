config = {
    ...
    "antimicrobial_resistance_genes":{
        ...
        "antimicrobial_resistance_genes_predictor_tool": ["abricate", "amrfinder"], # Select as many tools as desired to identify virulence genes: abricate and/or amrfinder. Keep in mind that abricate uses BLASTn and AMRFinder uses blastp.
        "abricate": {
            "antimicrobial_resistance_databases": ["card", "ncbi"], # Select as many databases as desired from ABRicate to identify antimicrobial resistance genes: argannot, card, ecoh, ecoli_vf, megares, ncbi or/and resfinder. Remember, ABRicate uses blastn. Default: ["card", "ncbi"]
            "mincov": 90, # Minimum DNA % coverage for considering a virulence gene as present. Default: 90
            "minid": 90 # Minimum DNA % identity for considering a virulence gene as present. Default: 90
        },
        "amrfinder": {
