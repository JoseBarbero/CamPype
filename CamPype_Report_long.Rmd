...
knitr::opts_chunk$set(dpi = 350, fig.align = "center")
```
...
BiocManager::install("ComplexHeatmap", force = FALSE); library(ComplexHeatmap)
BiocManager::install("ggtree", force = FALSE); library(ggtree)
```
...
| ape               | [Paradis and Schliep, 2019](https://https://cran.r-project.org/web/packages/ape/index.html) |
| complexHeatmap    | [Gu et al., 2016](https://www.bioconductor.org/packages/release/bioc/html/ComplexHeatmap.html) |
| cowplot           | [Wilke, 2020](https://cran.r-project.org/web/packages/cowplot/index.html) |
| dplyr             | [Wickham et al., 2022](https://cran.r-project.org/package=dplyr) |
| DT                | [Xie et al., 2022](https://cran.r-project.org/web/packages/DT/index.html) |
| ggplot2           | [Wickham, 2016](https://cran.r-project.org/package=ggplot2) |
| ggrepel           | [Slowikowski, 2021](https://cran.r-project.org/web/packages/ggrepel/) |
| ggtree            | [Yu et al., 2017](https://www.bioconductor.org/packages/ggtree) |
| pander            | [Daróczi and Tsegelskyi, 2022](https://cran.r-project.org/package=pander) |
| phytools          | [Revell, 2012](https://cran.r-project.org/package=phytools) |
| plotly            | [Sievert, 2020](https://cran.r-project.org/web/packages/plotly/index.html) |
| rjson             | [Couture-Beil, 2022](https://cran.r-project.org/web/packages/rjson/index.html) |
| rmarkdown         | [Allaire et al., 2022](https://cran.r-project.org/web/packages/rmarkdown/index.html) |
| scales            | [Wickham and Seidel, 2022](https://cran.r-project.org/web/packages/scales/index.html) |
