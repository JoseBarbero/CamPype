...
```{r results='asis', warning=FALSE, message=FALSE, echo=FALSE, dpi = 80, fig.width=22}
if(campype_config_json$virulence_genes$run_virulence_genes_prediction == TRUE) {
  if('abricate' %in% campype_config_json$virulence_genes$virulence_genes_predictor_tool) {
    Virulence_Genes_PA <- 
...
```{r results='asis', warning=FALSE, message=FALSE, echo=FALSE, dpi = 80, fig.width=35}
if(campype_config_json$virulence_genes$run_virulence_genes_prediction == TRUE) {
...
```{r results='asis', warning=FALSE, message=FALSE, echo=FALSE, dpi = 80, fig.width=10}
if(campype_config_json$virulence_genes$run_virulence_genes_prediction == TRUE) {
  if('blast' %in% campype_config_json$virulence_genes$virulence_genes_predictor_tool) {
    Virulence_Genes_PA <- 
