...
if(campype_config_json$MLST$run_mlst == TRUE) {
  if(campype_config_json$MLST$include_cc == TRUE) {
    ...
    MLST$Sample <- as.character(MLST$Sample) #NEW
...
if(campype_config_json$antimicrobial_resistance_genes$run_antimicrobial_resistance_genes_prediction == TRUE) {
  if('amrfinder' %in% campype_config_json$antimicrobial_resistance_genes$antimicrobial_resistance_genes_predictor_tool) {
    AMR_matrix <- 
      ...
      mutate(across(where(is_character), as_factor))
    AMR_matrix$Sample <- as.character(AMR_matrix$Sample) #NEW
...
if(campype_config_json$antimicrobial_resistance_genes$run_antimicrobial_resistance_genes_prediction == TRUE) {
  if('amrfinder' %in% campype_config_json$antimicrobial_resistance_genes$antimicrobial_resistance_genes_predictor_tool) {
    AMR_pmut_matrix <- 
      ...
      mutate(across(where(is_character), as_factor))
    AMR_pmut_matrix$Sample <- as.character(AMR_pmut_matrix$Sample) #NEW
