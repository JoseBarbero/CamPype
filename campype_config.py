config = {
    "output_directory": "autotest_results",    # "." is CamPype's directory (you need to have writing permissions to save CamPype's output in certain directories.)
    "custom_output_name": "config6", # Custom name for the output directory. Default (if this parameter is empty): "CamPype_OUTPUT_YYYYMMDD_HHMMSS"
