config = {
    ...
    "reference_genome": { # OPTIONAL: Select a reference genome of the same species you are analyzing (when possible) or if you don't want to use it, just leave every parameter empty
